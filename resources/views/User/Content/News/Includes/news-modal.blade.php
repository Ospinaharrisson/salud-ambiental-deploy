<div class="modal fade" id="article-modal-{{ $article->id }}" tabindex="-1" aria-labelledby="modalLabel{{$article->id}}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="app-modal-header modal-header d-flex justify-content-between align-items-center w-100">
            ...
            <div class="app-modal-footer modal-footer justify-content-start">
                @php
                ...
                @if($href)
                    <a href="{{ $href }}" target="_blank" class="btn app-btn-primary">Ver más información</a>
                @endif

                <button class="btn app-btn-secondary" data-bs-dismiss="modal">Cerrar</button>
            </div>
        </div>
    </div>
</div>
